...
// 6.handleContainer 当鼠标滑入container的时候,停止自动轮播同时让左右箭头展示出来,当鼠标滑出时,重启自动轮播,并且让左右箭头消失
...
handleArrow()
// 8. handelFocus 处理焦点图片 点击时切换图片:点击第一个焦点时,就该展示第一个图片,点击第二个焦点,就应该展示第二个图片,我们发现被点击的焦点的索引和需要展示的图索引一致,即和stepIndex一致,所以点击时修改stepIndex为点击焦点的索引
